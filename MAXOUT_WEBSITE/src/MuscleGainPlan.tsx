...
import { Utensils, Coffee, Beef, Apple, Clock } from "lucide-react";

function MuscleGainPlan() {
  const meals = [
    {
      icon: Coffee,
      title: "Breakfast",
      description: "4 eggs, oats, banana, whey protein shake",
      time: "07:00 AM",
    },
    {
      icon: Utensils,
    ...
    },
    {
      icon: Beef,
      title: "Dinner",
      description: "Lean beef, sweet potato, spinach",
      time: "07:00 PM",
    },
    {
      icon: Apple,
      title: "Snacks",
      description: "Greek yogurt, almonds, protein bar",
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <section className="pt-32 pb-16 px-6 text-center bg-gradient-to-br from-zinc-900 via-black to-zinc-800">
        <h2 className="text-5xl font-bold mb-4 text-brand">Muscle Gain Plan</h2>
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          High-protein meals designed to fuel strength and growth.
        </p>
      </section>
