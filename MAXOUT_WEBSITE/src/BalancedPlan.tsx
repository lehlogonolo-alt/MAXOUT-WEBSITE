...
import { Egg, Sandwich, Fish, CupSoda, Clock } from "lucide-react";
  ...
  const meals = [
    {
      icon: Egg,
      title: "Breakfast",
      description: "Whole-grain toast, avocado, scrambled eggs",
      time: "07:30 AM",
    },
    {
      icon: Sandwich,
      title: "Lunch",
      description: "Chicken wrap with veggies and hummus",
      time: "12:30 PM",
    },
    {
      icon: Fish,
      title: "Dinner",
      description: "Baked fish, roasted vegetables, couscous",
      time: "07:00 PM",
    },
    {
      icon: CupSoda,
      title: "Snacks",
      description: "Fruit smoothie, mixed nuts",
      time: "11:00 AM or 03:00 PM",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <section className="pt-32 pb-16 px-6 text-center bg-gradient-to-br from-zinc-900 via-black to-zinc-800">
        <h2 className="text-5xl font-bold mb-4 text-brand">Balanced Lifestyle Plan</h2>
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Flexible meals for sustainable health and fitness.
        </p>
      </section>
